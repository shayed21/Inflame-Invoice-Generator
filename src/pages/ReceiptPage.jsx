      ...
      <div className="flex-1 container mx-auto px-4 py-8 relative">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 text-lg font-medium mt-2">Create professional receipts instantly</p>
          </div>
          <div className="flex items-center">
            <Button
              onClick={handleDownloadPDF}
              disabled={isDownloading}
              className="mr-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700"
            >
              {isDownloading ? (
                <>
